          ...
          <div class="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
            <div class="xl:w-2/3 px-8 w-full xl:px-16">
              ...
              <form action="" class="flex flex-col gap-4">
                <input class="p-2 mt-4 rounded-lg border" type="email" name="email" value={payload.email} placeholder="Email" onChange={(e) => setPayload(prev => ({ ...prev, email: e.target.value }))} />
                <div class="relative">
                  <input class="p-2 rounded-lg border w-full" type="password" name="password" value={payload.password} placeholder="Password" onChange={(e) => setPayload(prev => ({ ...prev, password: e.target.value }))} />
              ...
              <div className="w-full flex items-center justify-center mt-3">
                <button onClick={() => { setLoading(true); handleSubmit() }} class="w-full bg-[#002D74] rounded-xl text-white py-2 hover:scale-105 duration-300">Đăng nhập</button>
              </div>
